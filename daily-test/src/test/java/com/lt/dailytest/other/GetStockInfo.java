...
/**
 * @author tong.luo
 * @description GetStockInfo
 * https://blog.csdn.net/u014646662/article/details/82936131
 * @date 2021/7/12 17:09
 */
public class GetStockInfo {
    private static String time = "2021-07-12 17:11:00";
    ...
    private static void stream(Stream<String> lines) throws ParseException, IOException {
